...
If you want to pass your pointers to a reference variable, you can do so with a simple pointer dereferencing. You are aware of the unsafety, as this is already an action you would take using Unsafe Jule. It also allows skipping the variable-based expression requirement of references.
