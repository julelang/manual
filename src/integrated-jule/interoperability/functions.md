...
## Linking Functions
Like variables, after the header file containing the C++ functions is passed to Jule, the C++ functions must be declared to Jule. Not all, just the ones you will use. But remember, julec does not check header files still.
