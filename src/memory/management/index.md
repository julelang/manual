...
By default, no memory space within Jule needs to be managed manually. However, approaches such as manual memory management can also be adopted and are allowed.