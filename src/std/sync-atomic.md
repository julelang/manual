...
[fn CompareAndSwap\[T: \~int \| \~uint \| \~i8 \| \~i16 \| \~i32 \| \~i64 \| \~u8 \| \~u16 \| \~u32 \| \~u64 \| \~uintptr\]\(mut &amp;addr: \*T, old: T, new: T, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap)\
[fn CompareAndSwapWeak\[T: \~int \| \~uint \| \~i8 \| \~i16 \| \~i32 \| \~i64 \| \~u8 \| \~u16 \| \~u32 \| \~u64 \| \~uintptr\]\(mut &amp;addr: \*T, old: T, new: T, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: i8, new: i8, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-1)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: i16, new: i16, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-2)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: i16, new: i16, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-2)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: i32, new: i32, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-3)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: i32, new: i32, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-3)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: i64, new: i64, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-4)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: i64, new: i64, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-4)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: int, new: int, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-5)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: int, new: int, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-5)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: u8, new: u8, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-6)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: u8, new: u8, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-6)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: u16, new: u16, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-7)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: u16, new: u16, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-7)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: u32, new: u32, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-8)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: u32, new: u32, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-8)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: u64, new: u64, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-9)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: u64, new: u64, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-9)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: uint, new: uint, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-10)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: uint, new: uint, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-10)\
...
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwap\(mut \*self, old: uintptr, new: uintptr, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswap-11)\
&nbsp;&nbsp;&nbsp;&nbsp;[fn CompareAndSwapWeak\(mut \*self, old: uintptr, new: uintptr, succ: memoryOrder, fail: memoryOrder\): \(swapped: bool\)](#compareandswapweak-11)\
...
const (
	...
	// visible to all coroutines that perform an Acquire or stronger
	// load of this value.
...
## CompareAndSwap
```jule
fn CompareAndSwap[T: ~int | ~uint | ~i8 | ~i16 | ~i32 | ~i64 | ~u8 | ~u16 | ~u32 | ~u64 | ~uintptr](mut &addr: *T, old: T, new: T, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation for value\. Only integer types are supported\.

## CompareAndSwapWeak
```jule
fn CompareAndSwapWeak[T: ~int | ~uint | ~i8 | ~i16 | ~i32 | ~i64 | ~u8 | ~u16 | ~u32 | ~u64 | ~uintptr](mut &addr: *T, old: T, new: T, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation for value\. Only integer types are supported\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: i8, new: i8, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: i8, new: i8, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: i16, new: i16, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: i16, new: i16, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: i32, new: i32, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: i32, new: i32, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: i64, new: i64, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: i64, new: i64, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: int, new: int, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: int, new: int, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: u8, new: u8, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: u8, new: u8, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: u16, new: u16, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: u16, new: u16, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: u32, new: u32, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: u32, new: u32, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: u64, new: u64, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: u64, new: u64, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: uint, new: uint, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: uint, new: uint, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
...
### CompareAndSwap
```jule
fn CompareAndSwap(mut *self, old: uintptr, new: uintptr, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.

### CompareAndSwapWeak
```jule
fn CompareAndSwapWeak(mut *self, old: uintptr, new: uintptr, succ: memoryOrder, fail: memoryOrder): (swapped: bool)
```
Executes the compare\-and\-swap operation\.
