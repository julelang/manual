...
[Variables](#variables)\
[fn ParseBool\(s: string\)\!: bool](#parsebool)\
[fn FormatBool\(b: bool\): string](#formatbool)\
[fn AppendBool\(mut dst: \[\]byte, b: bool\): \[\]byte](#appendbool)\
[fn ParseCmplx\(mut s: string, bitSize: int\)\!: cmplx128](#parsecmplx)\
[fn ParseFloat\(s: string, bitSize: int\)\!: f64](#parsefloat)\
[fn ParseUint\(mut s: string, mut base: int, mut bitSize: int\)\!: u64](#parseuint)\
[fn ParseInt\(mut s: string, base: int, mut bitSize: int\)\!: i64](#parseint)\
[fn Atoi\(mut s: string\)\!: int](#atoi)\
[fn FormatCmplx\(c: cmplx128, fmt: byte, prec: int, mut bitSize: int\): string](#formatcmplx)\
[fn FormatFloat\(f: f64, fmt: byte, prec: int, bitSize: int\): string](#formatfloat)\
[fn AppendFloat\(mut dst: \[\]byte, f: f64, fmt: byte, prec: int, bitSize: int\): \[\]byte](#appendfloat)\
[fn FormatUint\(i: u64, base: int\): string](#formatuint)\
[fn FormatInt\(i: i64, base: int\): string](#formatint)\
[fn AppendInt\(mut dst: \[\]byte, i: i64, base: int\): \[\]byte](#appendint)\
[fn AppendUint\(mut dst: \[\]byte, i: u64, base: int\): \[\]byte](#appenduint)\
[fn Itoa\(i: int\): string](#itoa)\
[fn Quote\(s: string\): string](#quote)\
[fn AppendQuote\(mut dst: \[\]byte, s: string\): \[\]byte](#appendquote)\
[fn QuoteToASCII\(s: string\): string](#quotetoascii)\
[fn AppendQuoteToASCII\(mut dst: \[\]byte, s: string\): \[\]byte](#appendquotetoascii)\
[fn QuoteToGraphic\(s: string\): string](#quotetographic)\
[fn AppendQuoteToGraphic\(mut dst: \[\]byte, s: string\): \[\]byte](#appendquotetographic)\
[fn QuoteRune\(r: rune\): string](#quoterune)\
[fn AppendQuoteRune\(mut dst: \[\]byte, r: rune\): \[\]byte](#appendquoterune)\
[fn QuoteRuneToASCII\(r: rune\): string](#quoterunetoascii)\
[fn AppendQuoteRuneToASCII\(mut dst: \[\]byte, r: rune\): \[\]byte](#appendquoterunetoascii)\
[fn QuoteRuneToGraphic\(r: rune\): string](#quoterunetographic)\
[fn AppendQuoteRuneToGraphic\(mut dst: \[\]byte, r: rune\): \[\]byte](#appendquoterunetographic)\
[fn CanBackquote\(mut s: string\): bool](#canbackquote)\
[fn UnquoteChar\(mut s: string, quote: byte\)\!: \(value: rune, multibyte: bool, tail: string\)](#unquotechar)\
[fn QuotedPrefix\(s: string\)\!: string](#quotedprefix)\
[fn Unquote\(s: string\)\!: string](#unquote)\
...
## ParseCmplx
```jule
fn ParseCmplx(mut s: string, bitSize: int)!: cmplx128
```
...
## ParseFloat
```jule
fn ParseFloat(s: string, bitSize: int)!: f64
```
...
## ParseUint
```jule
fn ParseUint(mut s: string, mut base: int, mut bitSize: int)!: u64
```
...
## ParseInt
```jule
fn ParseInt(mut s: string, base: int, mut bitSize: int)!: i64
```
...
## Atoi
```jule
fn Atoi(mut s: string)!: int
```
Is equivalent to ParseInt\(s, 10, 0\), converted to int\.

## FormatCmplx
```jule
fn FormatCmplx(c: cmplx128, fmt: byte, prec: int, mut bitSize: int): string
```
...
## FormatFloat
```jule
fn FormatFloat(f: f64, fmt: byte, prec: int, bitSize: int): string
```
...
## FormatUint
```jule
fn FormatUint(i: u64, base: int): string
```
...
## FormatInt
```jule
fn FormatInt(i: i64, base: int): string
```
Returns the string representation of i in the given base, for 2 &lt;= base &lt;= 36\. The result uses the lower\-case letters &#39;a&#39; to &#39;z&#39; for digit values &gt;= 10\.
...
## AppendQuote
```jule
fn AppendQuote(mut dst: []byte, s: string): []byte
```
...
## AppendQuoteToASCII
```jule
fn AppendQuoteToASCII(mut dst: []byte, s: string): []byte
```
...
```jule
fn AppendQuoteToGraphic(mut dst: []byte, s: string): []byte
```
...
## CanBackquote
```jule
fn CanBackquote(mut s: string): bool
```
...
## UnquoteChar
```jule
fn UnquoteChar(mut s: string, quote: byte)!: (value: rune, multibyte: bool, tail: string)
```
...
## QuotedPrefix
```jule
fn QuotedPrefix(s: string)!: string
```
