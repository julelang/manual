...
[fn IsAMD64\(arch: string\): bool](#isamd64)\
[fn IsARM64\(arch: string\): bool](#isarm64)\
[fn IsUnix\(os: string\): bool](#isunix)\
[fn Is32bit\(arch: string\): bool](#is32bit)\
[fn Is64bit\(arch: string\): bool](#is64bit)
...
## IsI386
```jule
fn IsI386(arch: string): bool
```
Reports whether architecture is intel 386\.

## IsAMD64
```jule
fn IsAMD64(arch: string): bool
```
...
## IsUnix
```jule
fn IsUnix(os: string): bool
```
Reports whether os is unix\.

## Is32bit
```jule
fn Is32bit(arch: string): bool
```
